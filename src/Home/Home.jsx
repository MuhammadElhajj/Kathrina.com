...
function Home() {
  return (
    <div className="Home">
      <h1 className="Home__Developer">Kathrina - Baker</h1>
        ...
        <div className="Developer__Information__One">
          ...
          <div className="Little__skills__Info">
            <p>
              ...
              Kathrina_Example.gmail.com
              </span>
            </p>
            <p>
              <CiLocationOn className="Little__skills__Info__Icon" />{" "}
              <span className="Little__skills__Info__Content">Canada</span>
            </p>
            <p>
