import "./About.css";
import AboutPicture from "../images/Muhammad.jpg";
    ...
    <div className="About">
      <div className="About__Part__One">
        ...
        <div className="About__Part__One__Information">
          ...
          <p className="About__Information__P">My name is Kathrina and I am specialize in Web developement  that utilizes <span>HTML</span> , <span>Css</span> , <span>JS</span> and <span>React.js</span> etc</p>
